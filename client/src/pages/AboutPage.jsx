...
const coreValues = [
  ...
  },
  {
    ...
    description:
      "Lapses are data, not failure. Break Free helps you notice what triggered the moment and how you can respond differently next time.",
  },
  {
    ...
    <div className="page">
      <section className="glass-panel">
        ...
        <p className="subtitle">
          Break Free exists to support anyone reducing or quitting an addictive
      ...
      <section className="pillars glass-panel">
        <h2 className="title">What makes Break Free different?</h2>
